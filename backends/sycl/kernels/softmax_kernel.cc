...
void SoftmaxGradKernel(const phi::Context& dev_ctx,
  ...
  show_kernel("SoftmaxGradKernel() out_dims"<< out_dims);
...
void SoftmaxKernel(const phi::Context& ctx,
  ...
  if constexpr (std::is_same<T, float>::value) {
    ...
    //std::cout<<"============ customdevice call softmax =============="<<std::endl;
    ...
    //std::cout<<"============ customdevice softmax memcpy create =============="<<std::endl;
    ...
    //std::cout<<"============ customdevice execute softmax =============="<<std::endl;
    // // Primitive execution.
    softmax_prim.execute(engine_stream, softmax_args);
    //std::cout<<"============ customdevice wait softmax =============="<<std::endl;
    // Wait for the computation to finalize.
    engine_stream.wait();
    //std::cout<<"============ customdevice softmax done =============="<<std::endl;
